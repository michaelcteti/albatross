...
RSpec.describe ShotsController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new shot as @shot" do
      ...
      expect(assigns(:shot)).to be_a_new(Shot)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created shot as @shot" do
        post :create, {:shot => valid_attributes}, valid_session
        expect(assigns(:shot)).to be_a(Shot)
        expect(assigns(:shot)).to be_persisted
      end

      it "redirects to the created shot" do
        post :create, {:shot => valid_attributes}, valid_session
        expect(response).to redirect_to(Shot.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved shot as @shot" do
        post :create, {:shot => invalid_attributes}, valid_session
        expect(assigns(:shot)).to be_a_new(Shot)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested shot" do
        shot = Shot.create! valid_attributes
        put :update, {:id => shot.to_param, :shot => new_attributes}, valid_session
        shot.reload
      ...
      it "redirects to the shot" do
        shot = Shot.create! valid_attributes
        put :update, {:id => shot.to_param, :shot => valid_attributes}, valid_session
        expect(response).to redirect_to(shot)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the shot as @shot" do
        shot = Shot.create! valid_attributes
        put :update, {:id => shot.to_param, :shot => invalid_attributes}, valid_session
        expect(assigns(:shot)).to eq(shot)
      end
